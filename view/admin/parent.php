      ...
      <div class="main">
        ...
        <main class="content">
          <div class="container-fluid p-0 d-flex align-items-center justify-content-between mb-2">
            <p class= "mb-3"><span style="font-size:14px; color:gray;">Dashboard</span> / <strong>Parent</strong></p>
        ...
        <div class="form-group">
             ...
             <div class="row px-4">
                ...
                <div class='col-12 col-md-4 space-100 col-lg-4 space-100'>
                 ...
                 <div class='col-12 col-md-4 space-100 col-lg-4 space-100'>
                 <label class='form-label font-bold-100 mb-2 mt-2 mb'>Street Address</label>
                  <input type="text" class='form-control' placeholder="Street Address...">
                 </div>
                 <div class='col-12 col-md-4 space-100 col-lg-3 space-100'>
                 <label class='form-label font-bold-100 mt-2'>City</label>
                  <input type="text" class='form-control' placeholder="City">
                 </div>
                 <div class='col-12 col-md-4 space-100 col-lg-3 space-100 mt-2'>
                 <label class='form-label font-bold-100 mt-2'>Parent Id</label>
                  <input type="text" class='form-control' placeholder="Parent Id" style="width:960px !important;">
                 </div>
                </div>
                <div class="px-4">
